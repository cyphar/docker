...
#include <linux/version.h>
    ...
    #warning "Headers from kernel >= 4.12 are required to build with Btrfs support."
    #warning "HINT: Set 'DOCKER_BUILDTAGS=exclude_graphdriver_btrfs' to build without Btrfs."
#endif
